	...
	public void call(String[] args) throws CmdException
	{
		if(args.length == 1)
		{
			if(args[0].equalsIgnoreCase("client"))
			{
				...
				String name = "Name: " + MC.getUser().getName();
				String sessionid = "Session id: " + MC.getUser().getSessionId();
			...
			{
				ServerData info = LastServerRememberer.getLastServer();
				if(info == null)
				...
				String list = "Players: " + info.playerList;
				String slots = "Player Slots: " + info.status.getString();
				String ip = "IP: " + info.ip;
				String motd = "MOTD: " + info.motd.toString();
				String name = "Server Name: " + info.name;
				String brand =
					"Server Brand: " + MC.player.connection.serverBrand();
